--// Конфигурация групп
local Groups = {
    ["Предметы"] = { "Prop_GoldBar", "Coal", "MoneyBag", "Bottle", "LeftUpperLeg", "Jar" },
    ["Оружие"] = { "Fuel", "Saddle", "RifleAmmo", "RevolverAmmo", "ShotgunShells", "Hadle", "Pump", "Cylinder", "Dynamite" },
    ["Монстры"] = { "HumanoidRootPart" }
}
